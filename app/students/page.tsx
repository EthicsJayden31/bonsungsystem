...
import { teacherName, useOperationsData, type DataSource } from "@/lib/operations-data";
...
function SourceNote({ source, error }: { source: DataSource; error: string }) {
  const text = source === "live" ? "Apps Script bootstrap의 학생 데이터를 표시합니다." : "실사용 세션이 없거나 연결에 실패해 Next preview 데이터를 표시합니다.";
  return (
