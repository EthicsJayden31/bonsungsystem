...
export default function GuardiansPage() {
  ...
  const { data } = useOperationsData(role);
  ...
  return (
    <AppShell area="guardians">
      <ResourcePage
        ...
        rows={data.guardians.map((guardian) => [studentName(data, guardian.studentId), guardian.name, guardian.relation, guardian.phone, guardian.payer ? <Badge key="payer" tone="good">예</Badge> : "아니오", guardian.emergency ? <Badge key="emergency" tone="warn">예</Badge> : "아니오", guardian.memo])}
        fields={[
